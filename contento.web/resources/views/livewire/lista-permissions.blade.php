                ...
                <table class="w-full text-sm text-left text-gray-500 whitespace-nowrap">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">
                                <div class="flex items-center">
                                    <button class="text-base" wire:click="sortBy('descripcion')">Descripción
                                        <x-sort-icon sortField="descripcion" :sort-by="$sortBy" :sort-asc="$sortAsc" />
                            ...
                            <th scope="col" class="px-6 py-3">
                                <div class="flex items-center">
                                    <button class="text-base" wire:click="sortBy('descripcion')">Roles asignados
                                    </button>
                                </div>
                            </th>
                    ...
                    <tbody>
                        @foreach ($permissions as $permission)
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4">
                                    @foreach ($permission->roles->pluck('name')->toArray() as $role)
                                        <span
                                            class="rounded-xl bg-sky-600 px-2 py-1 text-xs text-white">{{ $role }}</span>
                                    @endforeach
                                </td>
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <x-primary-button
                                        ...
                                        onmouseleave="removeTooltip(event,'top','tooltipGeneric','')"
                                        onblur="removeTooltip(event,'top','tooltipGeneric','')"
                                        wire:click="openModalDelete({{ $permission->id }})" type="button"
